...
echo "%CURRENTDIR%%~1"
echo "%~1"
set LOG=%CURRENTDIR%/import_transferoptionset.log
echo Importing import_transferoptionset...
...
%TC_ROOT%\bin\tcxml_import.exe -u=%IUID% -pf=%ipwfile% -g=dba -file="%CURRENTDIR%%~1" -scope_rules -scope_rules_mode=overwrite >> %LOG%
